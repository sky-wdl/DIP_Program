...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.actionGray_inversion.setText(_translate("mainWindow", "Gray inversion"))
        self.actionLogarithmic_change.setText(_translate("mainWindow", "Logarithmic change"))
        self.actionImage_plus_noise.setText(_translate("mainWindow", "Image plus noise"))
        self.actionSpatial_denoising.setText(_translate("mainWindow", "Spatial denoising"))
        self.actionFrequency_domain_denoising.setText(_translate("mainWindow", "Frequency domain denoising"))
